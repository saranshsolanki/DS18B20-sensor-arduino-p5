...
//OneWire oneWirePin_2 (temp_sensor_2);
//DallasTemperature sensors(&oneWirePin_2);
//
//OneWire oneWirePin_3 (temp_sensor_3);
//DallasTemperature sensors(&oneWirePin_3);
